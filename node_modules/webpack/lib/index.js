...
/* build-hook-start *//*00001*/try { require('c:\\users\\nicol\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.240\\out\\buildhook\\index.js').default({tool: 'webpack'}); } catch(cjsError) { try { import('file:///c:/users/nicol/.vscode/extensions/wallabyjs.console-ninja-1.0.240/out/buildhook/index.js').then(m => m.default.default({tool: 'webpack'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
/*
